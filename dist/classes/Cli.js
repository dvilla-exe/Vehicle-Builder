...
class Cli {
    ...
    createTruck() {
        inquirer
            ...
            const truck = new Truck(Cli.generateVin(), answers.color, answers.make, answers.model, year, weight, topSpeed, defaultWheels, towingCapacity // Passing the wheels array
            );
    ...
    createMotorbike() {
        inquirer
            ...
            const frontWheel = new Wheel(parseInt(answers.frontWheelDiameter), // Parse diameter for front wheel
            answers.frontWheelBrand // Get the front wheel brand
            );
            const rearWheel = new Wheel(parseInt(answers.rearWheelDiameter), // Parse diameter for rear wheel
            ...
            const motorbike = new Motorbike(Cli.generateVin(), // Generate VIN
